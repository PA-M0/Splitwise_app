            ...
            <form class="space-y-4 md:space-y-6" action="#">
              ...
              <div class="flex flex-row justify-between">
                <button type="button" @click="signUpWithGITHUB()" 
                  class="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-1 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30  mb-2">
                ...
                <button type="button" @click="signUpWithGOOGLE()"
                  class="text-gray-500 border hover:text-white    hover:bg-[#4285F4]/90 focus:ring-1 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55  mb-2">
